    ...
    <div className="flex items-center gap-3 rounded-2xl border bg-white p-3 shadow-sm">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex min-w-0 items-center gap-2">
          <div className="truncate text-sm font-medium text-gray-900" title={c.name}>
            {c.name}
          </div>
          <span className="whitespace-nowrap rounded-full bg-gray-100 px-2 py-0.5 text-xs text-gray-600" title={c.universe.name}>
            {c.universe.slug}
          </span>
        </div>
      </div>
